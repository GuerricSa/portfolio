...
export default function Footer() {
  ...
  return (
    <footer className="footer text-primary pt-8 mt-12">
      <div className="container">
        <div className='flex flex-wrap items-center justify-between gap-4 relative'>
          <div className="text-3xl font-bold lg:w-80">
          <Link
            to="/"
            onClick={(e) => {
            ...
            className="text-primary flex logo--hover-effect w-fit"
            onMouseEnter={(e) => {
        ...
        <button
          className={`z-100 bg-secondary w-6 h-6 flex items-center justify-center rounded-full -translate-x-2/4 fixed bottom-8 md:bottom-16 left-2/4 rotate-180 transition-all duration-600 hover:-translate-y-[5px] opacity-100 translate-y-0${!isTop ? " opacity-0 translate-y-48" : ""}`}
          onClick={() => scrollToTop()}
        >
        ...
        <nav className="py-4 justify-end flex">
            <button onClick={openModal}className="block py-2 group px-4" aria-label="Me contacter">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/GuerricSa" className="block py-2 group px-4" aria-label="Voir mon profil GitHub">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-center border-t-2 border-zinc-500 md:text-left py-4 flex justify-between flew-wrap px-4 lg:px-8">
          <p className="text-xs"> &copy; {new Date().getFullYear()} Guerric SANT. All rights reserved</p>
          <NavLink
            to="/cgv"
