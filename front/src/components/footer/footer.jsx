...
// import { ScrollToTop, ScrollToTopOnPathChange } from '../scroll-to-top/Scroll-to-top';
...
export default function Footer() {
  ...
  return (
    <footer className="footer text-primary pt-8 mt-12" role="contentinfo">
      <div className="container">
        <div className='flex flex-wrap items-center justify-between gap-4 relative'>
          ...
          {/* <ScrollToTop /> */}
          <nav className="py-4 justify-end flex" aria-label="Liens de contact">
            <button
              onClick={openModal}
              className="block py-2 group px-4"
